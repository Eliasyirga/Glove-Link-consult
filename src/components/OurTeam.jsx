...
export default function OurTeam() {
  ...
  return (
    <section className="w-full bg-gradient-to-tr from-green-100 via-white to-green-200 relative overflow-hidden py-28 px-6 sm:px-16 lg:px-28">
      {/* Floating animated blobs */}
      <div className="pointer-events-none absolute -top-40 -left-44 w-96 h-96 rounded-[45%] bg-green-300/30 blur-3xl animate-blob"></div>
      <div className="pointer-events-none absolute -bottom-44 -right-36 w-80 h-80 rounded-[40%] bg-yellow-300/25 blur-3xl animate-blob animation-delay-4000"></div>
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        <div className="w-24 h-1 mx-auto mb-10 rounded-full bg-gradient-to-r from-green-400 to-yellow-300 shadow-lg"></div>

        <p className="max-w-3xl mx-auto text-lg text-green-900/90 font-light leading-relaxed mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          {teamExpertise.map(({ title, icon, description }, idx) => (
            <article
              key={title}
              className="bg-white rounded-3xl shadow-lg border border-green-200 p-8
                hover:shadow-2xl hover:scale-[1.06] transition-transform duration-500 ease-in-out cursor-pointer
                flex flex-col"
              style={{
            ...
            >
              ...
              <div className="flex items-center gap-5 mb-6">
                <div
                  ...
                  bg-gradient-to-tr from-green-400 to-yellow-300 text-white shadow-lg"
                >
              ...
              <p className="text-green-900/90 text-base sm:text-lg font-medium leading-relaxed tracking-wide text-justify">
                {description}
              </p>
            </article>
          ))}
        ...
        <p className="mt-24 max-w-4xl mx-auto text-center text-green-900/70 font-light leading-relaxed text-lg">
